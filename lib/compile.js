...
function storeWatchCache(file){
    var tempFile = fis.file(file.realpath);
    tempFile.mtime = file.getMtime();
    revertFromMemory(tempFile, file);
 ...
 */
var exports = module.exports = function(file, memoryStore) {
    if (!CACHE_DIR) {
        ...
        if (memoryCache[file.realpath]) {
            ...
            if (watchCacheFile) {
                if (!checkWathFileExpires(watchCacheFile, file)) {
                    ...
                    isWatchModified = true;
                    delete watchCacheFile[file.realpath];
                    watchCacheFile = null;
                }
            }
        }
    ...
    if (file.isFile()) {
        if (file.useCompile && file.ext && file.ext !== '.') {
            ...
            file.useCache && !isWatchModified && exports.settings.watch && storeWatchCache(file);
        } else {
